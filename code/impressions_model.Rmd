...
#read in data
dt <- read_csv("~/Desktop/website_dev/google_ads/data/google-political-ads-transparency-bundle/google-political-ads-creative-stats.csv")
...
#Predict using the model
dt.test$pred_randomforest <- predict(model2, x.test, type="response")
