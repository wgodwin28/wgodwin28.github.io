...
shape.data %>%
  ...
  ggplot() + 
    ...
    ggtitle(paste0("Florida - June 2018 to December 2019"))
```
...
shape.data %>%
  ...
  ggplot() + 
    geom_sf(aes(fill=spending), color="gray30") +
    scale_fill_viridis_c(labels=comma, name="USD") +
    ggtitle(paste0("California - June 2018 to December 2019"))
```
...
shape.data %>%
  ...
  ggplot() + 
    geom_sf(aes(fill=spending), color="gray30") +
    scale_fill_viridis_c(labels=comma, name="USD") +
    ggtitle(paste0("Texas - June 2018 to December 2019"))
```
...
shape.data %>%
  ...
  ggplot() + 
    geom_sf(aes(fill=spending), color="gray30") +
    scale_fill_viridis_c(labels=comma, name="USD") +
    ggtitle(paste0("Tennessee - June 2018 to December 2019"))
```
...
shape.data %>%
  ...
  ggplot() + 
    geom_sf(aes(fill=spending), color="gray30") +
    scale_fill_viridis_c(labels=comma, name="USD") +
    ggtitle(paste0("Arizona - June 2018 to December 2019"))
```
...
shape.data %>%
  ...
  ggplot() + 
    geom_sf(aes(fill=spending), color="gray30") +
    scale_fill_viridis_c(labels=comma, name="USD") +
    ggtitle(paste0("Georgia - June 2018 to December 2019"))
```
...
This post highlights the primary geographical targets of political ad spending. My subsequent posts (and [Rshiny](https://wgodwin28.shinyapps.io/shiny_google_political_ads/)) will investigate time trends and identify the primary actors and funders behind the spending.